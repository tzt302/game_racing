...
- **赛道限制判罚**：每三次完整出界自动累计 5 秒罚时，并计入正赛排名。
...
- **速度相关物理**：最高速度 390 km/h，包含渐进转向、速度相关前轴下压力、轻刹入弯增益、受控侧滑、自动 8 挡变速箱和换挡动力中断。
- **多车 AI**：九名具有不同速度、侵略性和稳定性的 AI，会尝试超车、发生小失误并进行车体接触。
- **完整正赛发车**：玩家与九辆 AI 组成十车发车阵容，采用双列发车位和五盏红灯起步程序。
- **可调视野范围**：菜单提供标准、宽广和超宽三档，比赛中也可即时缩放。
- **真实大奖赛实录声音**：以 2006 巴西大奖赛现场 F1 发动机录音制作六层 RPM 循环，并随油门、负载和转速混合换挡断火、涡轮、回火与轮胎反馈。
